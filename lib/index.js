...
class ReactCountryFlag extends PureComponent {
    render() {
        const { code, svg, flagWidth, flagHeight, flagFontSize, cdnUrl } = this.props;
        const url = cdnUrl || `https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/2.8.0/flags/4x3/`;
        ...
        return emojiSupport() && !svg
            ...
            : <span
                  style={{
                      ...
                      backgroundImage: `url('${url}${code.toLowerCase()}.svg')`,
